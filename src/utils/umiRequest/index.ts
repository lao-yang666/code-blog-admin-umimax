...
import { getLocalStorageItem, getSessionStorageItem, getToken, isSuccess, logoutToLogin } from '@/utils' // 全局工具函数
...
const umiRequest: RequestConfig = {
  ...
  requestInterceptors: [
    (config: RequestOptions) => {
      // 获取 ACCESS_TOKEN
      const ACCESS_TOKEN = config.baseURL === BASEURL.API ? getToken()
        : getLocalStorageItem<string>(LOCAL_STORAGE.ACCESS_TOKEN)
