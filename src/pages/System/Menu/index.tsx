...
const TableList: React.FC<unknown> = () => {
  ...
  const formColumns: ProColumns<API.Menu>[] = [
    ...
    },
    {
      ...
      hideInSearch: true,
      initialValue: !!currentRecord.menu_id && typeof currentRecord.hideChildrenInMenu === 'number'
        ? String(currentRecord.hideInMenu) : '1',
      valueEnum: {
        '0': { text: '是', status: '是' },
        '1': { text: '否', status: '否' },
      },
    },
    {
      ...
      hideInSearch: true,
      initialValue: !!currentRecord.menu_id && typeof currentRecord.hideChildrenInMenu === 'number'
        ? String(currentRecord.hideChildrenInMenu) : '1',
      valueEnum: {
        '0': { text: '是', status: '是' },
        '1': { text: '否', status: '否' },
      },
  ...
  return (
    ...
    >
      <ProTable<API.Menu>
        ...
        toolBarRender={() => [
          <AccessButton
            ...
            type="primary"
            onClick={() => {
              handleModalVisible(true); handleTableAction('add');
              setCurrentRecord({} as any); setParentId(undefined)
            }}>
            新增菜单
          </AccessButton>,
        ]}
      ...
      />
      <DiyForm
        title={tableAction === 'edit' ? '编辑菜单' : '新增菜单'}
